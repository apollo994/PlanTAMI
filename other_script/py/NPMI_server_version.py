...
def main():
    ...
    parser.add_argument('--plaza', metavar='plaza',default="/home/zanarellof/NPMI/dataset/genefamily_data.orth.txt" ,help='the table from plaza with all family, species and genes')
...
################################################################################
    ...
    with open ("./"+args.sample+"_results/"+args.sample+"_stat.txt", "w") as stat_out:
        ...
        stat_out.write("Input genes in species 1 = "+str(len(sig_spID_sp1))+"\n")
        stat_out.write("Input families in species 1 = "+str(len(unique(sig_plazaID_sp1)))+"\n")
        stat_out.write("\n")
        stat_out.write("_INPUT SP2_"+"\n")
        ...
        stat_out.write("Input genes in species 2 = "+str(len(sig_spID_sp2))+"\n")
        stat_out.write("Input families in species 2 = "+str(len(unique(sig_plazaID_sp2)))+"\n")
        stat_out.write("\n")
        stat_out.write("_RESULTS_"+"\n")
        stat_out.write("Families in common between sp1 and sp2 = "+str(len(intersection_sig))+"\n")
        #famiglie significative in sp1
        #famiglie significative in sp1
